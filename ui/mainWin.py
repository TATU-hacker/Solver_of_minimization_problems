...
class Ui_MainWin(object):
    ...
    def retranslateUi(self, MainWin):
        ...
        MainWin.setWindowTitle(_translate("MainWin", "Harmony Search Algorithm - Gachon University © 2022"))
        self.label_2.setText(_translate("MainWin", "Provide a function"))
        self.label.setText(_translate("MainWin", "f(x)"))
        self.predefinedFunctionButton.setText(_translate("MainWin", "Select a predefined function"))
        self.label_3.setText(_translate("MainWin", "Number of iterations:"))
        ...
        self.nextButton.setText(_translate("MainWin", "Next"))
        self.label_12.setText(_translate("MainWin", "Solution"))
